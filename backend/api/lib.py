...
def parse_cli_args_with_defaults() -> CLIArgs:
    ...
    parser.add_argument(
        "--conversation-api-port", help="Conversation api port: 8081 (default)"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="Inference_provider type: 'kubernetes_pod' (default)",
    )
...
class EnvVars:
    ...
    inference_model_version: str = "v1.0"
    inference_engine_version: str = "v1.0"
